      ...
      <div className="text-center mt-16">
        <div className="inline-block p-8 bg-[#18171b] rounded-3xl shadow-elegant">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-6 py-3 bg-gradient-to-r from-[hsl(200,75%,55%)] to-[hsl(210,75%,35%)] text-white rounded-xl font-medium shadow-iris hover:shadow-gold transition-all duration-300">
              Узнать условия
            </button>
